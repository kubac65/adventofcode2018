...
def main():
    ...
    sleep_record = -1
    most_freqent_minute_freqency = -1
    most_frequent_minute = -1
    # Find quard who slept most
    for dwarf in dwarf_sleep_matrix:
        max_frequency = max(dwarf_sleep_matrix[dwarf])

        if max_frequency > most_freqent_minute_freqency:
            most_freqent_minute_freqency = max_frequency
    ...
    print(biggest_snoozer, most_frequent_minute, most_freqent_minute_freqency)
